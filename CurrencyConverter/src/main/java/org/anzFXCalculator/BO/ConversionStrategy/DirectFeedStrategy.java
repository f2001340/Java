...
/**
 * Direct Feed Class Implementation of our Conversion Strategy
 * @author SRI ADITYA
 * @version 1.0
 *
 */
public class DirectFeedStrategy implements ConversionStrategy {
	...
	public BigDecimal calculate(CurrencyUnit ccyUnit){
		...
		BigDecimal conversionRate = entry.get(sourceCCY + destCCY);
